...
| Malware protection | Daily malware scans publicly described | Not implemented for uploaded content | Add quarantine storage, antivirus/content-disarm scanning, file-type verification, and alerting before document release |
