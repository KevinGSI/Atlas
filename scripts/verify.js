...
const requiredFiles = [
  ...
  'Dockerfile', '.dockerignore', 'render.yaml', 'src/server.js', 'src/application.js', 'src/config.js', 'src/scheduler-leases.js', 'src/native-capabilities.js',
...
if (pkg.version !== '0.31.0') failures.push(`expected version 0.31.0, got ${pkg.version}`);
...
console.log(`Verification passed: version ${pkg.version}, ${requiredFiles.length} required files, ${sourceFiles} source modules, 25 database tables.`);
