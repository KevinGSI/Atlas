...
if (pkg.version !== '0.50.0') failures.push(`expected version 0.50.0, got ${pkg.version}`);
...
console.log(`Verification passed: version ${pkg.version}, ${requiredFiles.length} required files, ${sourceFiles} source modules, 34 database tables.`);
