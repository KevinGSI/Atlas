...
const requiredFiles = [
  ...
  'Dockerfile', '.dockerignore', 'render.yaml', 'src/server.js', 'src/application.js', 'src/config.js', 'src/scheduler-leases.js',
...
if (pkg.version !== '0.30.0') failures.push(`expected version 0.30.0, got ${pkg.version}`);
