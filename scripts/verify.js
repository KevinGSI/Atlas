...
const requiredFiles = [
  'package.json', 'pnpm-lock.yaml', 'README.md', 'AGENTS.md', 'IMPLEMENTATION_STATUS.md', '.env.example', 'docker-compose.yml', 'Launch Atlas Demo.command', 'Stop Atlas Demo.command', 'scripts/check-compliance.js', 'docs/ATLAS_PRODUCT_CONSTITUTION.md', 'docs/BUSINESS_MODEL.md', 'docs/COMPLIANCE_EVIDENCE_REGISTER.md', 'docs/EMAIL_CALENDAR_SETUP.md',
