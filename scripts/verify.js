...
const requiredFiles = [
  ...
  'test/postgres-repository.test.js', 'test/migrations.test.js', 'test/config.test.js', 'test/runtime.test.js', 'test/file-storage.test.js', 'test/file-security.test.js',
