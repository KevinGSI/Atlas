...
export class IntelligenceProjectionService {
  ...
  validate(result) {
    ...
    return { observations, actionProposals, awareness, knowledgeEmbeddings, retrievalChunks, chunkEmbeddings };
  }
