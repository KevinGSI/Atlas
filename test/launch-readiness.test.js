...
const valid = {
  ...
  CMS_SYNC_ENABLED:'true', PUBLIC_BASE_URL:'https://atlas.example.test', DOCUMENT_STORAGE_PROVIDER:'postgres', FILE_MALWARE_SCANNER:'clamav', CLAMAV_HOST:'clamav.internal'
};
